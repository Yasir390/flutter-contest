...
final class GetOfferCardRx
    extends RxResponseInt<OfferCardModel> {
  final api = GetOfferCardApi.instance;

  GetOfferCardRx({required super.empty, required super.dataFetcher});

  ValueStream get commentSteam => dataFetcher.stream;

  Future<OfferCardModel?> getOfferCardRx() async {
    try {
      final OfferCardModel data = await api.getOfferCardApi();
